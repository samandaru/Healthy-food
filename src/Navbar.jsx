...
import { Button, Container, Logo, NavItem } from './NavbarStyle'
        ...
        return (
            <Container>
               ...
                <NavItem onClick={()=>{this.setState({isActive:'home'})}} isActive={this.state.isActive === 'home'}>Home</NavItem>
                ...
                <NavItem onClick={()=>{this.setState({isActive:'contact'})}} isActive={this.state.isActive === 'contact'}>Contakt us</NavItem>
                <Button book bgcolor='#DC780B' >Booking Now</Button>
            </Container>
        )
    }
}
